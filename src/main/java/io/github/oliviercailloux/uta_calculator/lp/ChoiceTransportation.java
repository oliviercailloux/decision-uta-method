...
public class ChoiceTransportation {
	...
	private static void runLinearProgrammingExample(String solverType, boolean printModel) {
		...
		// Delta(RER,METRO1) = 0.07 w12 + w23 + - w32 - eRER+ + eRER- + eMETRO1+ -
		// eMETRO1- >= sigma
		...
		// Delta(METRO1,METRO2) = -0.14 w12 + w31 + w32 - METRO1+ + eMETRO1- + eMETRO2+
		// - eMETRO2- = 0
		...
		// Delta(METRO2,BUS) = 0.29 w12 + w21 + w22 - METRO2+ + eMETRO2- + eBUS+ - eBUS-
		// >= sigma
		...
		// Delta(BUS,TAXI) = w11 + 0.71 w12 - w21 - w31 - w32 - w33 - eBUS+ + eBUS- +
		// eTAXI+ - eTAXI- >= sigma
