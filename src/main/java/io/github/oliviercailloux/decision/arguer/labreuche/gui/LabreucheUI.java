			...
			public void actionPerformed(ActionEvent e) {
				if (varNbrAlternatives.getText().isEmpty()) {
					JOptionPane.showMessageDialog(null,
							"You need to give number the of alternatives you want for the example generated");
				}

				if (varNbrCriteria.getText().isEmpty()) {
					JOptionPane.showMessageDialog(null,
							"You need to give number the of criteria you want for the example generated");
				}
